...
xtForm.provider('xtFormConfig', function () {
    ...
    var self = this,
        _errors = {
            minlength: 'Deve ter ao menos {{ngMinlength}} caracteres',
            maxlength: 'O Campo não pode ser maior que {{ngMaxlength}} caracteres',
            required: 'Campo Obrigatório',
            number: 'Campo deve ser Numerico',
            min: 'Deve ter ao menos {{min}}',
            max: 'Deve ter no maximo {{max}}',
            email: 'Precisa ser um E-Mail Válido',
            pattern: 'Valor inválido',
            url: 'Deve ser uma URL',
            date: 'Deve ser uma Data',
            datetimelocal: 'Deve ser uma Data',
            time: 'Deve ser uma Hora válida',
            week: 'Deve ser uma Semana válida',
            month: 'Deve ser uma Mês válida',
            $$server: 'Ocorreu um problema'
        },
