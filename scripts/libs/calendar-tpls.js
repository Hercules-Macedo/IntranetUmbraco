...
angular.module("template/rcalendar/calendar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/calendar.html",
    ...
    "        </div>\n" +
    "        <div class=\"calendar-header col-xs-8 textUppercase\">{{title}}</div>\n" +
...
angular.module("template/rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/month.html",
    ...
    "                <small class=\"textUppercase\">{{label}}</small>\n" +
    "            </th>\n" +
    "        </tr>\n" +
    "        </thead>\n" +
    "        <tbody>\n" +
    ...
    "                    <td ng-if=\"!event.allDay\" class=\"monthview-eventdetail-timecolumn\">{{event.startTime|date: 'HH:mm': 'UTC'}}\n" +
    "                        -\n" +
    "                        {{event.endTime|date: 'HH:mm': 'UTC'}}\n" +
    "                    </td>\n" +
    "                    <td ng-if=\"event.allDay\" class=\"monthview-eventdetail-timecolumn\">Dia todo</td>\n" +
    "                    <td class=\"event-detail\" ng-click=\"eventSelected({event:event})\">{{event.title}}</td>\n" +
    "                </tr>\n" +
    "                <tr ng-if=\"!selectedDate.events\"><td class=\"no-event-label\">Nenhum Evento Encontrado</td></tr>\n" +
    "            </table>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>");
